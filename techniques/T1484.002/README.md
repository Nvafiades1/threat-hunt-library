...
**Technique ID:** `T1484.002` (sub-technique)  
**Tactic(s):** Defense Impairment, Privilege Escalation  
**Platforms:** Identity Provider, Windows  
**MITRE Reference:** [https://attack.mitre.org/techniques/T1484/002](https://attack.mitre.org/techniques/T1484/002)
